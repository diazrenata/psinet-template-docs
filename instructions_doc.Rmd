...
At least one of Automated and/or Manual Plant Water Potential must be supplied (green rows). All other variables are optional. Rows are color coded according to which table each variable is reported in.
